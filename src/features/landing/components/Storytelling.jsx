...
export function Storytelling() {
  ...
  const steps = [
    ...
    },
    {
      ...
      desc: <>Democratizamos el acceso a la justicia legal para inquilinos. Con IA, cualquier peruano puede entender su contrato, proteger su garantía y firmar con seguridad. <strong style={{ color: '#fbbf24' }}>Desde S/.0.</strong></>,
  ...
  return (
    <section id="storytelling" style={{
      ...
      <div className="blob" style={{ width: '600px', height: '600px', background: 'rgba(245,158,11,0.04)', top: '50%', left: '50%', transform: 'translate(-50%,-50%)' }} />
      ...
      <div className="container" style={{ position: 'relative', zIndex: 10 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '3rem 4rem', alignItems: 'center', marginBottom: '5rem' }} className="story-main-grid">
          {/* Video */}
          <div>
            <div className="story-video-wrapper" style={{ aspectRatio: '16/9' }}>
              ...
              {steps.map(step => (
                <div key={step.label} className="story-step" style={{ display: 'flex', alignItems: 'flex-start', gap: '1.25rem' }}>
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flexShrink: 0 }}>
                    ...
                    {step.showLine && (
                      <div className="story-timeline-line" style={{ width: '2px', height: '2rem', marginTop: '0.5rem' }} />
                    )}
                  </div>
