...
export function EmailCaptureB() {
  ...
  return (
    <section id="contacto" style={{
      ...
      <div className="blob-b" style={{ width: '500px', height: '300px', background: 'rgba(16,185,129,0.05)', top: 0, left: '50%', transform: 'translateX(-50%)' }} />
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <button
              ...
              onMouseEnter={e => { e.currentTarget.style.background = 'linear-gradient(to right, #059669, #0891b2)'; e.currentTarget.style.transform = 'translateY(-2px)'; }}
              onMouseLeave={e => { e.currentTarget.style.background = 'linear-gradient(to right, #10b981, #06b6d4)'; e.currentTarget.style.transform = 'translateY(0)'; }}
            >
              <span>Enviar</span>
          ...
          <div style={{ marginTop: '1.5rem', paddingTop: '1.5rem', borderTop: '1px solid #1b263b', display: 'grid', gridTemplateColumns: '1fr', gap: '1rem' }} className="perks-grid">
            {[
              ...
              <div key={perk.title} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
                <span style={{ fontSize: '1.125rem', flexShrink: 0, color: '#34d399' }}>{perk.icon}</span>
                <div>
