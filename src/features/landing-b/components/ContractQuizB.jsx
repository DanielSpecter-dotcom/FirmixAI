import { useContractQuiz } from '../../landing/hooks/useContractQuiz';

/**
 * ContractQuizB — quiz interactivo de 3 preguntas con captura de leads, paleta Emerald/Cyan (variante B).
 * Los colores rojo/ámbar/verde del gauge de riesgo se mantienen: son semánticos (nivel de riesgo),
 * no decorativos, igual que en DemoSlideshowB.
 */
export function ContractQuizB() {
  const {
  ...
  return (
    <section id="contract-quiz" style={{
      ...
      <div className="blob-b" style={{ width: '300px', height: '300px', background: 'rgba(16,185,129,0.05)', top: '10px', right: '10px' }} />
      <div className="blob-b" style={{ width: '300px', height: '300px', background: 'rgba(6,182,212,0.05)', bottom: '10px', left: '10px' }} />
          ...
          {step === 0 && (
            <div>
              <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
                <div style={{
                  width: '3rem', height: '3rem', background: 'rgba(16,185,129,0.1)',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', maxWidth: '28rem', margin: '0 auto' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: 'linear-gradient(to right, #10b981, #06b6d4)',
                    color: '#0b0f19', fontWeight: 700, fontSize: '0.75rem',
        ...
        {q.options.map(opt => (
          <button
            ...
            style={{
              ...
              background: selected === opt.key ? 'rgba(16,185,129,0.1)' : '#060911',
              border: `1px solid ${selected === opt.key ? 'rgba(16,185,129,0.4)' : '#1b263b'}`,
          ...
          >
            ...
            <span style={{
              ...
              border: `1px solid ${selected === opt.key ? '#10b981' : '#334155'}`,
              background: selected === opt.key ? '#10b981' : 'transparent',
...
function QuizResult({ score, leadName, leadGoal, onReset }) {
  ...
  // Colores del gauge de riesgo: semánticos (rojo/ámbar/verde), no decorativos — se mantienen iguales en A y B.
  ...
  return (
    <div style={{ textAlign: 'center', paddingTop: '1.5rem' }}>
      ...
      <h3 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#fff' }}>
        Reporte de Riesgo para <span style={{ color: '#34d399' }}>{leadName || 'ti'}</span>
      </h3>
      ...
      <div style={{ padding: '1.5rem', background: '#060911', border: '1px solid #1b263b', borderRadius: '1rem', maxWidth: '30rem', margin: '0 auto', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(135deg, rgba(16,185,129,0.05), transparent)', pointerEvents: 'none' }} />
