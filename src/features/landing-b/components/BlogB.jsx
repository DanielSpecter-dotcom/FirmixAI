/**
 * BlogB — 5 tarjetas de artículos con links externos, paleta Emerald/Cyan (variante B).
          ...
          {posts.map(post => (
            <div
              ...
              style={{
                ...
                border: `1px solid ${post.featured ? 'rgba(16,185,129,0.25)' : '#1b263b'}`,
                borderTop: post.featured ? '3px solid #10b981' : undefined,
                borderRadius: '1rem',
                display: 'flex', flexDirection: 'column', justifyContent: 'space-between',
                transition: 'border-color 0.2s',
              }}
              onMouseEnter={e => e.currentTarget.style.borderColor = 'rgba(16,185,129,0.3)'}
              onMouseLeave={e => e.currentTarget.style.borderColor = post.featured ? 'rgba(16,185,129,0.25)' : '#1b263b'}
            >
              <div>
                <span style={{ fontSize: '0.625rem', fontWeight: 800, color: '#34d399', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
