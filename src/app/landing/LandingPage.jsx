...
const SEO_LANDING_A = {
  ...
  canonical: 'https://firmixai.vercel.app/landing-a',
  ogImage: 'https://firmixai.vercel.app/img/og-landing-a.png',
  jsonLd: {
    ...
    operatingSystem: 'Web',
    url: 'https://firmixai.vercel.app/landing-a',
    description:
    ...
    provider: {
      '@type': 'Organization',
      name: 'Firmix IA',
      url: 'https://firmixai.vercel.app',
      logo: 'https://firmixai.vercel.app/img/LogoFirmix2.png',
      address: {
        '@type': 'PostalAddress',
        addressCountry: 'PE',
